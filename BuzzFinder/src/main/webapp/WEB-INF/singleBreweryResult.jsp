					...
					<c:forEach var="breweryReview" items="${breweryReviews}">
						<table>
							<tr>
								...
								<th width="20%">Best Beer</th>
								<th width="60%">Best Feature</th>
								<th width="10%">Returning?</th>
							</tr>
							<tr>
								<td>${breweryReview.rating }</td>
								<td>${breweryReview.favoriteBeer }</td>
								<td>${breweryReview.feature }</td>
								<td>${breweryReview.again}</td>
							</tr>
						</table>
					</c:forEach>
				</c:when>

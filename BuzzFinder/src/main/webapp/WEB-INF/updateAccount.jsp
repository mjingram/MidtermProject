	...
	<div class="mainContent">
		<div class="innerContent">
			...
			<form action="sendUpdateAccount.do">
				<input type="hidden" name="id" value="${accountInfo.id }" /> <label>First
					Name:</label> <input type="text" class="form-control" name="firstName"
					value="${accountInfo.firstName }"> <label>Last
					Name:</label> <input type="text" class="form-control" name="lastName"
					value="${accountInfo.lastName }"> <label>Street:</label> <input
					type="text" class="form-control" name="address.street"
					value="${addressInfo.street }"> <label>City:</label> <input
					type="text" name="address.city" class="form-control"
					value="${addressInfo.city }"> <label>State:</label> <input
					type="text" class="form-control" name="address.state"
					value="${addressInfo.state }"> <label>Zipcode:</label> <input
					type="text" class="form-control" name="address.zipcode"
					value="${addressInfo.zipcode }"> <input type="hidden"
					name="address.id" class="form-control" value="${addressInfo.id }">
				<input type="submit" value="Send" class="btn btn-light updateBtn">


			</form>

			<form action="profile.do">
				<button type="submit" class="btn btn-light profileBtn">Profile</button>
			</form>

...
<div class="mainContent">
	...
	<h1>Find a brew or brewery</h1>
	<form action="getBreweryByName.do" method="GET">
		<label> Enter Brewery Name Here: </label>
		<input type="text" name="name" size="25" class="form-control"/> 
		<input type="submit" value="Get Brewery" class="btn btn-light getBreweryBtn"/>
	</form>

	<form action="displayBeer.do" method="GET">
		<label>Enter Beer Name Here: </label>
		<input type="text" name="name" size="25" class="form-control"/> 
		<input type="submit" value="Get Beer" class="btn btn-light getBeerBtn"/>
	</form>

	<form action="getBeerByStyle.do" method="GET">
		<label> Beer Style:</label> <input type="text" name="beerStyle" size="25" class="form-control"/>
		<input type="submit" value="Get Beers" class="btn btn-light getBeerBtn"/>
	</form>

	<form action="getBreweryByLocation.do" method="GET">
		<label> Enter City Here:</label> <input type="text" name="city" size="15" class="form-control"/>
		<label class="stateLabel"> Enter State Here:</label> <input type="text" name="state" size="10" class="form-control"/>
		<input type="submit" value="Find Breweries" class="btn btn-light getBreweryBtn"/>
	</form>

...
CREATE TABLE IF NOT EXISTS `brewery` (
  ...
  `favorite_beer` VARCHAR(200) NULL,
  `rating` INT NULL,
...
START TRANSACTION;
USE `mybeerdb`;
INSERT INTO `brewery` (`id`, `name`, `address_id`, `image_url`, `logo_image_url`, `favorite_beer`, `rating`, `again`) VALUES (1, 'NorthGate Brewing', 1, NULL, NULL, NULL, NULL, NULL);
